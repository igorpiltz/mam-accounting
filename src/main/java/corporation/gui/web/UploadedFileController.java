...
public class UploadedFileController extends HttpServlet {
	
	static Logger log = LoggerFactory.getLogger(UploadedFileController.class);
	
	private static String INSERT_OR_EDIT = "/fel.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.info("UploadedFileController.GET(" + action + "): ");
		...
		if (action.equalsIgnoreCase("delete")) {
			...
			forward = "/UploadedFileController.do?action=listAll&bookId=" + bookId;
	...
	public void doPost( HttpServletRequest request,
		...
		if (secAction.equalsIgnoreCase("testScript")) {
			...
			List<Account> liabilitiesAccounts = dao.getAccountsByClass(book, AccountClass.LIABILITIES);
			accounts.addAll(liabilitiesAccounts);
